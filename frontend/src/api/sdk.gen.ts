...
/**
 * Submit Creative Composition
 *
 * Submit composition directly from the creative detail workflow.
 */
export const submitCreativeCompositionApiCreativesCreativeIdSubmitCompositionPost = <ThrowOnError extends boolean = false>(options: Options<SubmitCreativeCompositionApiCreativesCreativeIdSubmitCompositionPostData, ThrowOnError>) => (options.client ?? client).post<SubmitCreativeCompositionApiCreativesCreativeIdSubmitCompositionPostResponses, SubmitCreativeCompositionApiCreativesCreativeIdSubmitCompositionPostErrors, ThrowOnError>({ url: '/api/creatives/{creative_id}/submit-composition', ...options });
...
/**
 * List Publish Pool Items
 */
export const listPublishPoolItemsApiCreativePublishPoolGet = <ThrowOnError extends boolean = false>(options?: Options<ListPublishPoolItemsApiCreativePublishPoolGetData, ThrowOnError>) => (options?.client ?? client).get<ListPublishPoolItemsApiCreativePublishPoolGetResponses, ListPublishPoolItemsApiCreativePublishPoolGetErrors, ThrowOnError>({ url: '/api/creative-publish-pool', ...options });

/**
 * Get Publish Pool Item
 */
export const getPublishPoolItemApiCreativePublishPoolPoolItemIdGet = <ThrowOnError extends boolean = false>(options: Options<GetPublishPoolItemApiCreativePublishPoolPoolItemIdGetData, ThrowOnError>) => (options.client ?? client).get<GetPublishPoolItemApiCreativePublishPoolPoolItemIdGetResponses, GetPublishPoolItemApiCreativePublishPoolPoolItemIdGetErrors, ThrowOnError>({ url: '/api/creative-publish-pool/{pool_item_id}', ...options });

/**
 * Submit Ai Clip Workflow
 */
export const submitAiClipWorkflowApiCreativeWorkflowsCreativeIdAiClipSubmitPost = <ThrowOnError extends boolean = false>(options: Options<SubmitAiClipWorkflowApiCreativeWorkflowsCreativeIdAiClipSubmitPostData, ThrowOnError>) => (options.client ?? client).post<SubmitAiClipWorkflowApiCreativeWorkflowsCreativeIdAiClipSubmitPostResponses, SubmitAiClipWorkflowApiCreativeWorkflowsCreativeIdAiClipSubmitPostErrors, ThrowOnError>({
