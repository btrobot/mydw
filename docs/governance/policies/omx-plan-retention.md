...
| `prd-pr3-copy-and-state-unification.md` / `test-spec-pr3-copy-and-state-unification.md` / `slice-plan-pr3-copy-and-state-unification.md` | PR-3 已完成，正式 docs 已吸收其 scope、验证口径、执行顺序与 closeout truth | `docs/governance/next-phase-pr3-copy-and-state-unification-plan.md`、`docs/governance/next-phase-test-spec.md`、`docs/governance/next-phase-execution-breakdown.md`、`docs/governance/inventory/pr3-copy-and-state-unification-closeout.md` |
