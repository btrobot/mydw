...
async def test_creative_openapi_exposes_phase4_workbench_and_detail_contracts(
    ...
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["current_cover_thumb"]["anyOf"][0]["type"] == "string"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["current_copy_excerpt"]["anyOf"][0]["type"] == "string"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["selected_video_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["selected_audio_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["candidate_video_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["candidate_audio_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["candidate_cover_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["definition_ready"]["type"] == "boolean"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["composition_ready"]["type"] == "boolean"
    assert schemas["CreativeWorkbenchItemResponse"]["properties"]["missing_required_fields"]["type"] == "array"
    ...
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["selected_video_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["selected_audio_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["candidate_video_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["candidate_audio_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["candidate_cover_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["definition_ready_count"]["type"] == "integer"
    assert schemas["CreativeWorkbenchSummaryResponse"]["properties"]["composition_ready_count"]["type"] == "integer"
