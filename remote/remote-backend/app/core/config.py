...
class Settings(BaseSettings):
    ...
    ADMIN_STEP_UP_RATE_LIMIT_WINDOW_SECONDS: int = 60
    ADMIN_STEP_UP_RATE_LIMIT_MAX_ATTEMPTS: int = 5
    ...
    PASSWORD_HASH_DEFAULT_ALGO: str = "argon2id"
    PASSWORD_HASH_ARGON2_TIME_COST: int = 3
    PASSWORD_HASH_ARGON2_MEMORY_COST_KB: int = 65536
    PASSWORD_HASH_ARGON2_PARALLELISM: int = 4
    PASSWORD_HASH_ARGON2_HASH_LEN: int = 32
    PASSWORD_HASH_ARGON2_SALT_LEN: int = 16
